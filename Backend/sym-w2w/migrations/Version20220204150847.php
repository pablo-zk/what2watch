...
final class Version20220204150847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, rol JSON NOT NULL, UNIQUE INDEX UNIQ_1483A5E9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
//        $this->addSql('ALTER TABLE content_list ADD CONSTRAINT FK_89AA15DDA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
...
//        //INSERTAR 2 USUARIOS
//        $this->addSql('insert into user (id, username,password,rol) values (1, "admin", "$argon2id$v=19$m=65536,t=4,p=1$0fvkXpHdHuS1IIPYeqj/Tg$WoCUkN4zRl80TedHReCeYruDEd0+cfEwqKoasZCzZGI", "ROLE_ADMIN")' );
//        $this->addSql('insert into user (id, username,password,rol) values (2, "ander", "$argon2id$v=19$m=65536,t=4,p=1$0fvkXpHdHuS1IIPYeqj/Tg$WoCUkN4zRl80TedHReCeYruDEd0+cfEwqKoasZCzZGI", "ROLE_USER")' );
//        //INSERTAR 4 PELICULAS/SERIES DE TMBD
//        $this->addSql('insert into content (id, id_content,title,cover,media_type) values (1, 774825, "The Ice Age Adventures of Buck Wild", "/iJDPnoZ7IafVxrxq0qRUsoBINoR.jpg", "movie")' );
//        $this->addSql('insert into content (id, id_content,title,cover,media_type) values (2, 85552, "Euphoria", "/288q0JefZUuTfqUG2qzPTCZYuAL.jpg", "tv")' );
//        $this->addSql('insert into content (id, id_content,title,cover,media_type) values (3, 99966, "Estamos muertos", "/erEJz0JgS3pVZAl7fl38cShK1Bs.jpg", "tv")' );
//        $this->addSql('insert into content (id, id_content,title,cover,media_type) values (4, 85552, "Euphoria", "/288q0JefZUuTfqUG2qzPTCZYuAL.jpg", "tv")' );
//        //INSERTAR 4 LISTAS PARA LOS 2 USUARIOS
//        $this->addSql('insert into content_list (id, title,icon,user_id) values (1, "Me gusta", "heart", 1)' );
//        $this->addSql('insert into content_list (id, title,icon,user_id) values (2, "Me gusta", "heart", 2)' );
//        $this->addSql('insert into content_list (id, title,icon,user_id) values (3, "Vistas", "heart", 1)' );
//        $this->addSql('insert into content_list (id, title,icon,user_id) values (4, "Comedia", "heart", 2)' );
